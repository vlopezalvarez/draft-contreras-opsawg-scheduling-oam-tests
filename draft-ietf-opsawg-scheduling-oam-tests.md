...
When a new `unitary-test` or `test-sequence` is scheduled, the request MAY be rejected depending on the server's capability to evaluate the scheduling impact and detect conflicts prior to execution.
